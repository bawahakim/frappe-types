...
class TestTypeGenerator(FrappeTestCase):
    ...
    def test_generate_types_for_doctype(self):
        ...
        with open(TestTypeGeneratorUtils.get_types_output_path(), "r") as f:
            content = f.read()
            self.assertEqual(sanitize_content(content), TestTypeGeneratorUtils.get_expected_ts_file(with_child_table=False))
    ...
    def test_generate_types_for_doctype_with_child_table(self):
        ...
        with open(TestTypeGeneratorUtils.get_types_output_path(), "r") as f:
            content = f.read()
            self.assertEqual(sanitize_content(content), TestTypeGeneratorUtils.get_expected_ts_file(with_child_table=True))
    ...
    def test_updates_types(self):
        ...
        with open(TestTypeGeneratorUtils.get_types_output_path(), "r") as f:
            content = f.read()
            self.assertEqual(sanitize_content(content), TestTypeGeneratorUtils.get_expected_ts_file(with_updated_fields=True))
